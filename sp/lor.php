    ...
    <main>
        <div class="container">
            <div class="item">
                ...
                <div class="img-items">
                    <img src="../img/i33.png" alt="" class="img">
                    <img src="../img/i33-33.png" alt="">

                </div>
            </div>
            <div class="item-sidebar">
                <div class="detail-item-sidebar">
                    <div class="name-item">LORRYLOAD CARGO SHORT</div>
                    <div class="masp">SKU: HBHT0001</div>
                    <div class="cost"><span>270.000</span><sup>đ</sup></div>
                    <div class="color">
                        Màu sắc
