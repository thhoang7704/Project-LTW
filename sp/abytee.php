    ...
    <main>
        <div class="container">
            <div class="item">
                ...
                <div class="img-items">
                    <img src="../img/i8.png" alt="" class="img">
                    <img src="../img/i8-8.png" alt="">

                </div>
            </div>
            <div class="item-sidebar">
                <div class="detail-item-sidebar">
                    <div class="name-item">ABYSS SS24 INSECT AFFECTION TEE</div>
                    <div class="masp">SKU: HBHT0001</div>
                    <div class="cost"><span>200.000</span><sup>đ</sup></div>
                    <div class="color">
                        Màu sắc
