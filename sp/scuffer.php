...
<head>
    ...
    <link rel="stylesheet" href="../css/cart.css">nk
    ...
    <main>
        <div class="container">
            <div class="item">
                ...
                <div class="img-items">
                    <img src="../img/i16.png" alt="" class="img">
                    <img src="../img/i16-16.png" alt="">

                </div>
            </div>
            <div class="item-sidebar">
                <div class="detail-item-sidebar">
                    <div class="name-item">SCUFFERS LOVE POLO</div>
                    <div class="masp">SKU: HBHT0001</div>
                    <div class="cost"><span>450.000</span><sup>đ</sup></div>
                    <div class="color">
                        Màu sắc
