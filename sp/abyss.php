    ...
    <main>
        <div class="container">
            <div class="item">
                ...
                <div class="img-items">
                    <img src="../img/i18.png" alt="" class="img">
                    <img src="../img/i18-18.png" alt="">

                </div>
            </div>
            <div class="item-sidebar">
                <div class="detail-item-sidebar">
                    <div class="name-item">ABYSS SS24 MYSTIC WING WAX TEE</div>
                    <div class="masp">SKU: HBHT0001</div>
                    <div class="cost"><span>490.000</span><sup>đ</sup></div>
                    <div class="color">
                        Màu sắc
